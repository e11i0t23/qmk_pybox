...
def FlashDFUwin(mcu, file):
    ...
    erase = run(["dfu-programmer", mcu, "erase"], shell=True, capture_output=True)
    ...
    flash = run(["dfu-programmer", mcu, "flash", path.abspath(file)], shell=True, capture_output=True)
    #print(flash)
    ...
    run(["dfu-programmer", mcu, "reset"], shell=True, capture_output=True)
